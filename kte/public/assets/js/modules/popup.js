...
import { clickEvent, removeClass, removeElement, addClass } from '../lib/utilities.js';
import { createShadow, closeBtn, modalFocus, scrollable, closeItem } from './modals.js';
...
const closePopupIcon = (popup) => {
	const closePopupIcon = closeBtn(popup, `${CLASSNAME.CLOSEICON}`, `4rem`, ID.CLOSEPOPUP, () => closeModal(popup));
